...
namespace Golbaus_BE.Migrations
{
    ...
    [Migration("20240222094942_Add_NewestQuestion")]
    partial class Add_NewestQuestion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Golbaus_BE.Entities.NewestPost", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Golbaus_BE.Entities.TrendingPost", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Golbaus_BE.Entities.NewestPost", b =>
                {
                    b.HasOne("Golbaus_BE.Entities.Post", "Post")
                        .WithOne("NewestPost")
                        .HasForeignKey("Golbaus_BE.Entities.NewestPost", "PostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
