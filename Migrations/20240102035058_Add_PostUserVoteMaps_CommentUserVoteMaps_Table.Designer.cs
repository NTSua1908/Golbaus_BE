...
namespace Golbaus_BE.Migrations
{
    ...
    [Migration("20240102035058_Add_PostUserVoteMaps_CommentUserVoteMaps_Table")]
    partial class Add_PostUserVoteMaps_CommentUserVoteMaps_Table
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Golbaus_BE.Entities.CommentUserVoteMap", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("varchar(255)");
            ...
            modelBuilder.Entity("Golbaus_BE.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEFcgiD9jUjaAINqjLe4kVxPsUat3zrfzmF6FIbruERoamJ4hGIuqZ4z5gOaPfHHIIw==",
                        ...
                        new
                        {
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEC4SPrSykwAJB6io8cRUVb/xCZ035wChiEQQUocUkPgcu/aQ54DxU3ycoPciKFdhRA==",
                            PhoneNumberConfirmed = false,
                            PostCount = 0,
                            SecurityStamp = "",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("Golbaus_BE.Entities.CommentUserVoteMap", b =>
                {
                    b.HasOne("Golbaus_BE.Entities.Comment", "Comment")
                        .WithMany("CommentUserVoteMaps")
            ...
            modelBuilder.Entity("Golbaus_BE.Entities.Comment", b =>
                {
                    ...
                    b.Navigation("CommentUserVoteMaps");
                });
